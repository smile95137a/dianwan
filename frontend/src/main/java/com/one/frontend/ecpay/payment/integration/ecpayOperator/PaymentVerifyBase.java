package com.one.frontend.ecpay.payment.integration.ecpayOperator;

import com.one.frontend.ecpay.payment.integration.errorMsg.ErrorMessage;
import com.one.frontend.ecpay.payment.integration.exception.EcpayException;
...
public class PaymentVerifyBase{
	protected String confPath = "C:/Users/a0970/IdeaProjects/oneKuJi/frontend/src/main/java/com/one/frontend/ecpay/payment/integration/config/EcpayPayment.xml";
	protected Document doc;
	public PaymentVerifyBase(){
		System.out.println(confPath);
		File file = new File(confPath);
		System.out.println("123123" + file.toString());
		doc = EcpayFunction.xmlParser(file.toString());
