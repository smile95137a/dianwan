package com.one.frontend.ecpay.payment.integration.verification;

import com.one.frontend.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.one.frontend.ecpay.payment.integration.ecpayOperator.PaymentVerifyBase;
