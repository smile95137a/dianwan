...
public interface OrderRepository {
	...
	@Insert("INSERT INTO `order` (order_number, user_id, total_amount, shipping_cost, is_free_shipping, "
			...
			+ "billing_address, invoice, tracking_number , shipping_phone , shop_id , OPMode , e_payaccount , bill_number , state , donation_code) "
			...
			+ "#{billingAddress}, #{invoice}, #{trackingNumber} , #{shippingPhone} , #{shopId} , #{OPMode} , #{ePayAccount} , #{billNumber} , #{state} , #{donationCode})")
